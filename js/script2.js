...
gsap.to(".box2-2", {
  scrollTrigger: {
   ...
   xPercent: -44, left:"50%", duration: 4,
});
    gsap.to(".box2-3", {
  scrollTrigger: {
    trigger: ".box2",
...
gsap.to(".box2-2", {
  scrollTrigger: {
   ...
   xPercent: -40, left:"50%", duration: 4,
});
    gsap.to(".box2-3", {
  scrollTrigger: {
    trigger: ".box2",
